...
class Solution {
    ...
    ArrayList<Integer> inOrder(Node root) {
        // Create an ArrayList to store the inorder traversal result
        ArrayList<Integer> arr = new ArrayList<>();
        
        // Call the helper function to perform the inorder traversal
        helper(root, arr);
        
        // Return the ArrayList containing the inorder traversal
        return arr;
    }
